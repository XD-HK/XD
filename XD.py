...
def check(session,coki):
    ...
    if len(game)==0:
        ...
        for gm in game:
            ...
            print(f"\033[1;97m---\033[1;96m"+gm.replace('huwtn',' hxw-code=yaseen-33'))
...
def gmail():     
        ...
        first = input(f'{oo("?")}Put First Name:Yaseen ')
 
        last = input(f'{oo("?")}Put Last Name: Sana')
 
        domain = input(f'{oo("?")}Put Domain: Love u fnds')
...
def pak():
	...
	code = input(f'{oo("!")}Put Code :0344.0348.0300.0312.0318.0320 ')
